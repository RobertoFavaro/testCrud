...
import com.test.testCrud.CRUD.Test.controllers.StudentController;
import com.test.testCrud.CRUD.Test.entities.Student;
import com.test.testCrud.CRUD.Test.services.StudentService;
...
public class StudentControllerTest {
    ...
    void updateStudenteId() throws Exception {
        Long studenteId = 1L;
        Student updateStudente = new Student(studenteId, "Francesco", "Totti", false);
